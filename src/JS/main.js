...
document.getElementById('types-menu').addEventListener('change', (eve) => filtrarTipo(eve.target.value));
...
document.getElementsByName('pokemon-name')[0].addEventListener('change', (eve) => busquedaPorNombre(eve.target.value));
